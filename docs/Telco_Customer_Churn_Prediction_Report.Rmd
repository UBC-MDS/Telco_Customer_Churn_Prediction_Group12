...
```{r class imbalance echo=FALSE,  out.width = 60}
...
```{r numerical features distribution echo=FALSE,  out.width = 60}
...
```{r numerical features correlation echo=FALSE,  out.width = 60}
knitr::include_graphics("../results/figure_3_numeric_feat_corr.png")
```
...
```{r categorical features summary echo=FALSE,  out.width = 60}
...
```{r categorical demographic features echo=FALSE,  out.width = 60}
...
```{r categorical service features echo=FALSE,  out.width = 60}
